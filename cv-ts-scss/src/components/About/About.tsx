            ...
            <div className="about">
                ...
                <p className="about__content">
                    <p>
                        ...
                        enjoy studying and lately I have been deeply immersed in programming and I
                        study application development from start to finish.
                    </p>
                    <p>
                        Specifically, I like creating something out of nothing. There is an idea and
                        you build it from the ground up. When you start, there is just a blank text
                        editor like a blank sheet of paper. When you’re done, there’s a working
                        program in the end. I like research. Programming tends to involve much
                        googling and reading through documentation.
                    </p>
                </p>
                ...
                <p className="about__skills">
                    <ul>
                        ...
                        <li>
                            I have little experience in creating / editing containers, as well as
                            their assembly / disassembly (<b> Docker</b>)
                        </li>
