            ...
            <p className="about__skills">
                <ul>
                    <li>
                        ...
                        <b>HTML</b>,<b>CSS</b>,<b>SASS(SCSS)</b>
                        <b>BEM</b>
                    </li>
                    ...
                    <li>
                        I used DB (<b>PostgreSQL</b>
                        <b>MongoDB</b>) in my projects with <b>Typeorm</b>
                    </li>
                    ...
                    <li>I have some experience of joint development with the team</li>
                </ul>
            </p>
        </div>
    );
